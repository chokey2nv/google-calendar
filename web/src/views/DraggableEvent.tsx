...
export interface DraggableEventProps { 
  ...
  onEditEvent: (eventId: string, event: Partial<ICalendarEvent>) => Promise<void>;
...
export const DraggableEvent: React.FC<DraggableEventProps> = ({ event, onEditEvent, onDeleteEvent }) => {
  const ref = React.useRef<HTMLDivElement>(null);
  const { onOpenModal, onCancel } = useEventDetailModal();
